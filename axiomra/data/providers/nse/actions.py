"""NSE Corporate Action CSV Provider and Parser."""
...
class NSECorporateActionProvider:
    """Parses NSE corporate action reports into structured CorporateAction models."""
    ...
    def parse_actions_bytes(
        ...
        """Parse raw NSE Corporate Action CSV bytes into structured CorporateAction records."""
        ...
        for row in reader:
            ...
            # Resolve canonical instrument_id
    ...
    def _classify_purpose(self, purpose: str) -> tuple[CorporateActionType | str, float | None, float | None]:
        ...
        # Dividend extraction (e.g., "DIVIDEND - RS 5 PER SHARE" or "INTERIM DIVIDEND - RS 2.50")
        ...
        # Bonus extraction (e.g., "BONUS 1:1" -> 2.0, "BONUS 1:2" -> 1.5)
        if "BONUS" in p_upper:
            ratio = None
        ...
        # Split / Sub-Division (e.g., "SPLIT FROM RS 10 TO RS 2" -> ratio = 5.0)
